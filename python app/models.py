...
class User(db.Model):
    ...
    avatar_url = db.Column(db.String(max), nullable=True)
    phone_number = db.Column(db.String(15), nullable=True)
    address = db.Column(db.String(max), nullable=True)
...
class Painting(db.Model):
    ...
    image_url = db.Column(db.String(max), nullable=True)
...
class Comment(db.Model):
    ...
    user_id = db.Column(db.String(20), db.ForeignKey('users.user_id'), nullable=False)
    comment_text = db.Column(db.String(max), nullable=False)
    created_at = db.Column(db.DateTime, nullable=False)
